    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="relative overflow-hidden">
        <div
          ...
          style={{
            backgroundImage:
              "radial-gradient(circle at 20% 10%, var(--color-gold) 0, transparent 40%), radial-gradient(circle at 90% 80%, var(--color-primary) 0, transparent 45%)",
          }}
        />
              ...
              {products.filter((p) => p.category === cat).map((p) => (
                <article key={p.slug} className="group">
                  ...
                  <Link
                    to="/product/$slug"
                    params={{ slug: p.slug }}
                    className="mt-4 block w-full rounded-full border border-border bg-card py-2.5 text-center text-sm font-medium transition group-hover:border-primary group-hover:bg-primary group-hover:text-primary-foreground"
                  >
                    View details
                  </Link>
                </article>
